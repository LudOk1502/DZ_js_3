...
for (const simpson of simpsons) {
    document.write(`<div style="text-transform: uppercase"> ${simpson.name}- ${simpson.surname}- ${simpson.age}- ${simpson.info}- <img src="${simpson.photo}">
</div>`)
}
/*<!--template 2.2-->
        <div>
...
for (const simpson of simpsons) {
    document.write(`<div>
<h2><span style="text-transform: uppercase">${simpson.name} ${simpson.surname}.</span>age is - ${simpson.age} </h2>
<p>${simpson.info}</p>
...
<h3 class="product-title"><span style="text-transform: uppercase">${product.title}.</span> Price - ${product.price}</h3>
